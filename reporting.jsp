...
<form name="f1"  action="DBreporting" method="post" >
...
(5) Name of Candidate (Mr./Ms)<br>
    (As in HS/SS Certificate)<input type="text" name="name"  required="required" /><br><br>
...
(8)Image<input type="file" name="file" /><br><br>
(9) <b>Declaration: I solemny declare on oath that the entries made by me in the above columns are true to the best of my knowledge and belief.</b><br><br> 
