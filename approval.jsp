	...
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test");
      ...
      recipient = email;
       subject = "AMU, Counseling Approval !!!";
        content ="Hello "+name+", \n Your Counseling id: "+did+"is approved.\nBy: AMU Counseling ";   
      }
...
pstmt.setString(1, "approved"); // set input parameter 1
...
out.println("Document approved successfully..../n and e-mail sent to the candidate.");
